...
const RemindersPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    axios
      ...
      .then((res) => {
        console.log('Respuesta de /api/negocio/:id:', res.data);
        setModuloRecordatorios(!!res.data.modulo_recordatorios);
        setReminders(res.data.recordatorios || []);
      })
      .catch((err) => {
        console.error('Error al cargar estado de recordatorios:', err.response?.data || err.message);
  ...
  const addReminder = async () => {
    try {
      ...
      console.error('Error al agregar recordatorio:', err.response?.data || err.message);
  ...
  const toggleReminder = async (id: number) => {
    ...
    try {
      ...
      console.error('Error al actualizar estado del recordatorio:', err.response?.data || err.message);
  ...
  const handleDeleteReminder = async (id: number) => {
    ...
    try {
      ...
      console.error('Error al eliminar el recordatorio:', err.response?.data || err.message);
  ...
  const handleEditReminder = async () => {
    ...
    try {
      ...
      console.error('Error al actualizar el recordatorio:', err.response?.data || err.message);
      showMessage(err.response?.data?.error || 'Error al actualizar el recordatorio', 'error');
    }
  };
